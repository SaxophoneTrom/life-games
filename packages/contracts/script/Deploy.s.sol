 ...
 *   - TRUSTED_SIGNER_ADDRESS: Address for signature verification (same as EPOCH_MINTER_ADDRESS)
...
contract Deploy is Script {
    ...
    function run() external {
        ...
        // Trusted signer can be same as epoch minter or different
        address trustedSigner = vm.envOr("TRUSTED_SIGNER_ADDRESS", epochMinter);
        ...
        SegmentNFT segmentNFT = new SegmentNFT(
            deployer,           // owner
            trustedSigner,      // trustedSigner for signature verification
